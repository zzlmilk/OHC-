...
<html xml:lang="en" xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script  type="text/javascript" src="<?php echo ($PUBLIC); ?>/js/lostPassword.js"></script>
        ...
        <script>
            $(function() {
                ...
                $('#imgEmsure2').mousedown(function(){
                    $('#imgEmsure2').attr('src',WebsitePublic+'/image/Home/Index/ensure.png');
                })
                $('#imgEmsure2').mouseup(function(){
                    $('#imgEmsure2').attr('src',WebsitePublic+'/image/Home/Index/ensure2.png');
                })
                $('#imgEmsure2').mouseout(function(){
                    $('#imgEmsure2').attr('src',WebsitePublic+'/image/Home/Index/ensure2.png');
                })
            })
        </script>
...
<div style="clear: both;"></div>
            <div id="lostpasswordEmail_div" style=" height: 340px;">
                <div style=" margin: 55px 0 0 60px;">
                    <?php if($state == 1 ): ?>update password successly,please login
                        <?php else: ?>
                        <form action="<?php echo U('User/info/updatePassword');?>"  method="post" id="setpasswordform" name="setpasswordform" >
                            <input type="hidden" name="email" id="email" value="<?php echo ($email); ?>" />
                            <div style=" color: #5C5857;font-size: 18px;letter-spacing: 1px;font-weight: bold;">Please enter a new password (Minimum 6 characters, case sensitive):</div>
                            <div style=" margin-top: 30px;">
                                <input type="password" onkeydown="KeyDown(event,'lostpassword')"  name="lostpassword" id="lostpassword" class="textStyle" />             
                            </div>

                            <div style=" color: #5C5857;font-size: 18px; margin-top: 30px;letter-spacing: 1px;font-weight: bold;">Please type in your password again:</div>
                            <div style=" margin-top: 30px;">
                                <input type="password"  onkeydown="KeyDown(event,'lostpassword')" name="relostpassword" id="relostpassword" class="textStyle" />             
                            </div>

                            <div style="color:red; margin-top: 15px;" id="lostpassword_state"></div>
                            <div id="ensure" onclick="checkPasswordSubmit()">
                                <img id="imgEmsure2" src="<?php echo ($PUBLIC); ?>/image/Home/Index/ensure2.jpg"/>
                            </div>
                        </form><?php endif; ?>
