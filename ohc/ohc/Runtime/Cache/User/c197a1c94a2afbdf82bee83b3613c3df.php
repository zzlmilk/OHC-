...
<div style="  margin-left: 70px;height: 80px; ">
    <span class="pointer" style="float: left;"></span>
    <p class="agreeP">
        Please fill the questionnaire carefully and ensure the objectiveness and accuracy of the information you are going to    provide. 
    </p>
</div>
...
<div style="  margin-left: 70px;height: 90px; ">
    ...
    <p class="agreeP" >
        Please get ready the bill explanation from your insurer or the  agreement between you and the provider, if you are not insured before you click the next button.
            ...
            <div style=" width: 114px;  height: 43px; position: relative; ">
                <a  href="<?php echo U('Medical/review/registerreview');?>" style=" position: absolute; left:100px; top: 8px; ">
                    <img src="<?php echo ($PUBLIC); ?>/image/Home/register/register_nex.png" width="114" height="43">
                </a>
                <a  href="<?php echo U('User/register/register_next');?>" style=" color: black; position: absolute; left:240px; top: 22px; width: 100px; ">
                   not right now
                </a>
            </div>
