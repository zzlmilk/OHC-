...
(function ($) {
	$.fn.WBjsScroll = function (o) {
		...
		function init(e) {
			...
			if (Scroll_main.height() > self_data.height) {
				...
				Scroll_Outside = self.find(".Scroll_Outside")
                                                 self.append("<div id='dddd' style=' position:absolute;width: 100%;overflow: hidden;right:12px; top:-1px; *top:-1px;*height:1px;border-top:2px solid black'></div>");
                                                 self.append("<div id='dddd' style=' position:absolute;width: 100%;overflow: hidden;right:12px; top:199px;*top:179px; border-bottom:1px solid black'></div>");
		...
		function ShowScroll_y() {
			self.append("<div id='Scroll_y'class='Scroll_y' style=' position:absolute; right:4px; top:0px;'></div>");
