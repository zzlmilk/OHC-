                    ...
                    <TD>
                        ...
                        <table id="subtree2" style="DISPLAY: none" width="95%" border="0" align="center" cellpadding="0" ellspacing="0" class="left-table02">
                            <tr>
                                ...
                                <td width="85%"><a href="{$URLController}redirst.php?action=review" target="mainFrame" class="left-fontSmall" onClick="tupian('4')">review</a></td>
                                                            <tr>
                                <td width="15%" height="20" ><img id="xiaotu8" src="./images/ico06.gif" width="8" height="12" /></td>
                                <td width="85%"><a href="{$URLController}redirst.php?action=revising" target="mainFrame" class="left-fontSmall" onClick="tupian('8')">revising</a></td>
                        </table>
                        <TABLE width="100%" border="0" cellpadding="0" cellspacing="0" class="left-table03" id="table1" >
                            <tr>
                                <td height="29">
                        ...
                        <table id="subtree3" style="DISPLAY: none" width="95%" border="0" align="center" cellpadding="0" ellspacing="0" class="left-table02">
                            <tr>
                                ...
                                <td width="85%"><a href="{$URLController}redirst.php?action=excel&filetype=doctor" target="mainFrame" class="left-fontSmall" onClick="tupian('5')">doctor excel import</a></td>
                            </tr>      


                            <tr>
                                <td width="15%" height="20" ><img id="xiaotu6" src="./images/ico06.gif" width="8" height="12" /></td>
                                <td width="85%"><a href="{$URLController}redirst.php?action=excel&filetype=produce" target="mainFrame" class="left-fontSmall" onClick="tupian('6')">produceal excel import</a></td>
                            </tr>    

                            <tr>
                                <td width="15%" height="20" ><img id="xiaotu7" src="./images/ico06.gif" width="8" height="12" /></td>
                                <td width="85%"><a href="{$URLController}redirst.php?action=excel&filetype=hospital" target="mainFrame" class="left-fontSmall" onClick="tupian('7')">hosptial excel import</a></td>
                            </tr>    
                        ...
                        <table id="subtree10" style="DISPLAY: none" width="95%" border="0" align="center" cellpadding="0" ellspacing="0" class="left-table02">
                            <tr>
                                ...
                                <td width="85%"><a href="{$URLController}redirst.php?action=visit" target="mainFrame" class="left-fontSmall" onClick="tupian('16')">user visit</a></td>
                            </tr>      
