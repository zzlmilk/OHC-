...
//    字符截取
    function cut_str($string, $sublen, $start = 0, $code = 'UTF-8') {
        ...
        function page0($php, $page, $data,$pageSize=4) {
        $Page_size = $pageSize;
        $init = 1;
        $page_len = 6;
        $count = count($data);
        ...
        $key1.="<span>$page/$pages</span>&nbsp;";    //第几页,共几页
        if ($page != 1) {
            $key1.="&nbsp;&nbsp;<a href=" . $php . "&function=pageFunction&page=1>首页</a> ";     //第一页
            $key1.="&nbsp;&nbsp;<a href=" . $php . "&function=pageFunction&page=" . ($page - 1) . ">上一页</a>"; //上一页
        } else {
            $key1.="&nbsp;&nbsp;首页 "; //第一页
            $key1.="&nbsp;&nbsp;上一页"; //上一页
        }
        ...
        for ($i = $init; $i <= $max_p; $i++) {
            if ($i == $page) {
                ...
                $key1.=" <a href=\"" . $php . "&function=pageFunction&page=" . $i . "\">" . $i . "</a>";
            }
        }

        if ($page != $pages) {
            $key1.=" &nbsp;&nbsp;<a href=\"" . $php . "&function=pageFunction&page=" . ($page + 1) . "\">下一页</a> "; //下一页
            $key1.="&nbsp;&nbsp;<a href=\"" . $php . "&function=pageFunction&page={$pages}\">最后一页</a>"; //最后一页
        } else {
            $key1.="&nbsp;&nbsp;下一页 "; //下一页
            $key1.="&nbsp;&nbsp;最后一页"; //最后一页
        }
